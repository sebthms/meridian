...
import { addAttributeWithName, updateAttribute, addAssociationAttribute, updateAssociationAttribute, setAttributeIdentifier } from '@/editor'
import { isValidModelName, modelNameError, parseAttributeTypeConfig, type AttributeTypeConfig, type ConceptualType, type DateTimeKind, type NumericBits, type NumericKind, type OtherKind, type TextCharset, type TextStorage } from '@/domain'
