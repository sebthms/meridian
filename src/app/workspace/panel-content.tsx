...
import { ProjectTreePanel } from '../../features/diagram/components/project-tree-panel'
import { ProjectManagerPanel } from '../../features/project-library/components/project-manager-panel'
import { SettingsPanel } from '../../features/settings/components/settings-panel'
import { SqlPanel } from '../../features/sql-export/components/sql-panel'

const IssuesPanel = lazy(() =>
  import('../../features/validation/components/issues-panel').then(({ IssuesPanel }) => ({ default: IssuesPanel })),
)
