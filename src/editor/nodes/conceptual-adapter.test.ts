...
import { createInheritance, createModelConstraint, createFunctionalDependencyConstraint, createBusinessRule, createProject, createEntity } from '@/domain'
import { projectToEdges, projectToNodes } from './adapter'
